    ...
    <div className="mt-24 relative">
      ...
      <div className="flex flex-col md:flex-row items-start mb-8 md:mb-12 relative z-10">
        <div className="flex items-center w-full md:w-1/2 justify-start md:justify-end pr-0 md:pr-8 pl-16 md:pl-0 mb-4 md:mb-0">
          <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-xl border border-white/20 w-full max-w-md">
      ...
      <div className="flex flex-col md:flex-row-reverse items-start mb-8 md:mb-12 relative z-10">
        <div className="flex items-center w-full md:w-1/2 justify-start md:justify-start pr-0 pl-16 md:pl-8 mb-4 md:mb-0">
          <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-xl border border-white/30 w-full max-w-md">
            <h3 className="text-2xl text-white font-semibold mb-3">
              Step 2: Upload Chat
            </h3>
            <p className="text-white/80">
