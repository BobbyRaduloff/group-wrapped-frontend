  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col md:flex-row items-start mb-8 md:mb-12 relative z-10">
        ...
        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-black/20 shadow-lg absolute left-6 md:left-1/2 -translate-x-1/2 top-0 md:top-1/2 md:-translate-y-1/2">
